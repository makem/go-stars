...
//	});
	...
	$('#logout a').click(function(e) {
		...
		// ask verification
		$.SmartMessageBox({
			title : "<i class='fa fa-sign-out txt-color-orangeDark'></i> Закрыть сессию '<span class='txt-color-orangeDark'><strong>" + $('#show-shortcut').text() + "</strong></span>' ?",
...
function drawBreadCrumb() {
	...
	$.bread_crumb.empty();
	$.bread_crumb.append($("<li>Stars</li>"));
